...
where tablespace_name='C_TEMP' group by inst_id, tablespace_name --order by sum(free_blocks)
union ALL
...
gv$sort_segment where tablespace_name='C_TEMP' group by tablespace_name;